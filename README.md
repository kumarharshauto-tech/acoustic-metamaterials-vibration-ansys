...
- Developed finite element models of aluminium beam and plate structures in ANSYS Workbench
- Performed modal analysis to identify natural frequencies and structural mode shapes
- Conducted harmonic-response analysis under variable-frequency excitation
- Investigated acoustic metamaterial and dynamic vibration absorber concepts for low-frequency vibration control
- Evaluated total deformation, equivalent von Mises stress, principal strain and directional deformation
- Applied mesh-refinement and analytical-verification procedures to assess model reliability
- Reported mesh convergence with less than approximately 1% change in monitored natural frequencies after further refinement
- Reported agreement of the first simply supported plate natural frequency with the analytical solution to within approximately 3%
- Assessed the potential application of locally resonant vibration-control concepts to lightweight automotive NVH-sensitive structures
